...
The application's function is analysed in further detail in my diploma thesis (in Greek), which can be found here:  
[Development of a smartphone application for improving food intake behaviour based on real time meal weight measurements](https://github.com/ArisPapangelis/CFIApp/blob/main/Thesis_Papangelis.pdf)
